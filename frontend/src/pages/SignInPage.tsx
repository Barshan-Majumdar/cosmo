...
import { Rocket, Sparkles, BookOpen, Brain } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#050505] text-white font-inter flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 py-12">
          ...
          >
            Continue where you left off. Your AI-powered study companion is
            ready to help you master any concept.
          </motion.p>
          ...
          >
            {[
              { icon: Sparkles, text: "AI-Powered Study Plans" },
              { icon: BookOpen, text: "Smart Syllabus Analysis" },
              { icon: Brain, text: "Interactive AI Tutor" },
            ].map((feature, index) => (
